...
public class UserController {
    ...
    public UserController(UserService userService, ProjectMapper projectMapper, ApplicationMapper applicationMapper, UserMapper userMapper) {
    ...
    @PutMapping("{id}/projectParticipated")
